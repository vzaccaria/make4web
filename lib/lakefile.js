(function(){
  var _, color, moment, ref$, filter, map, bbo, ita, cl, cd, mprint, pd, mok, merr, pathSystem, recomputePaths, silent, sensitiveDirs, tag, savePid, watch, nodemon, watchWRate, serve, echo, echoStep, echoOk, ct, ce, bt, ht, le, targets, help, npmGitAction, gitAction, makeify, getvar, all, join, changeType, rebaseTo, takeName, takeDir, trim, reduceTo, now, resetTargets, addToTargets, getTargets, o, cc, m, x, p, it, foreachFileIn, foreachFileInExpression, collectTargets, joinTargets, copyTargets, installVariable, installFile, generateMakefileConfigPs, task, pretty, hooksData, hooks, translationPlugins, plugins, generateMakefileExt, join$ = [].join, this$ = this;
